...
public class SequentialMergeSortVisualizer extends JPanel {
    ...
    public SequentialMergeSortVisualizer(int size) {
    ...
    private static class SequentialMergeSortVisualizable extends SequentialMergeSort {
        private final SequentialMergeSortVisualizer visualizer;

        public SequentialMergeSortVisualizable(SequentialMergeSortVisualizer visualizer) {
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Sequential Merge Sort Visualization");
        SequentialMergeSortVisualizer panel = new SequentialMergeSortVisualizer(50); // 50 elements
        frame.add(panel);
        frame.pack();
